...
import me.projectx.module.impl.render.Hud.hudGui;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.ingameGUI = new hudGui(this);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + ClientBase.instance.Info[0] + " Version" + ClientBase.instance.Info[1] + "...");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        EventBind eventBind = new EventBind(k);
                        eventBind.call();
                        if (k == 1)
                        {
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                return !s.equals("vanilla") ? "Definitely; ClientBase brand changed to \'" + s + "\'" : (Minecraft.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and client brand is untouched.");
            }
        });
        theCrash.getCategory().addCrashSectionCallable("Type", new Callable<String>()
        {
            public String call() throws Exception
            {
                return "ClientBase (map_client.txt)";
            }
        });
        ...
        theCrash.getCategory().addCrashSectionCallable("Profiler PositionUtils", new Callable<String>()
        {
            public String call() throws Exception
            {
