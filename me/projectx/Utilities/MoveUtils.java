...
public class MoveUtils {
    ...
    public static void strafe(double speed) {
        ...
        } if (mc.gameSettings.keyBindRight.isPressed() && !mc.gameSettings.keyBindLeft.isPressed() && !mc.gameSettings.keyBindForward.isPressed() && !mc.gameSettings.keyBindBack.isPressed()) {
